...
const { authentication, isAuthorPost, isAdmin } = require('../middleware/authentication');
...
router.put('/id/:_id',authentication,uploadPostImages.single('imagePost'), PostController.update);
